...
* [Migrate from an existing ASP.NET app](#migrate-from-an-existing-project)
...
Follow this section to get this project working. Before you begin, ensure you have the latest version of [hasura cli tool](https://docs.hasura-stg.hasura-app.io/0.15/manual/install-hasura-cli.html) installed.
